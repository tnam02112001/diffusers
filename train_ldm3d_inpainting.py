...
from src.diffusers import AutoencoderKL, DDPMScheduler, UNet2DConditionModel
from src.diffusers.optimization import get_scheduler
from src.diffusers.training_utils import EMAModel
from src.diffusers.utils import check_min_version, deprecate, is_wandb_available, make_image_grid
from src.diffusers.utils.import_utils import is_xformers_available
...
def log_validation(vae, text_encoder, tokenizer, unet, args, accelerator, weight_dtype, epoch):
    ...
    pipeline = StableDiffusionLDM3DInpaintPipeline.from_pretrained(
...
def parse_args():
    ...
    parser.add_argument(
        "--image_column", type=str, default="URL", help="The column of the dataset containing an image."
    )
    parser.add_argument(
        "--caption_column",
        type=str,
    ...
    parser.add_argument("--use_ema", action="store_true", help="Whether to use EMA model.", default=True)
    parser.add_argument(
        "--non_ema_revision",
        type=str,
        default=None,
...
def main():
    ...
    unet = UNet2DConditionModel.from_pretrained(
        args.pretrained_model_name_or_path, subfolder="unet", revision=args.non_ema_revision, in_channels=9, low_cpu_mem_usage=False, ignore_mismatched_sizes=True 
    )
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(unet):
                ...
                latents = vae.encode(init_concat).latent_dist.sample()
